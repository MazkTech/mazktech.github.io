...
<body class="bg-dark text-white">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.html">Chanze Tiggs</a>
    ...
    <div class="container text-center mt-5">
        ...
        <p class="lead text-secondary">Infrastructure Engineer | Security | Automation</p>
        <hr class="my-4">
